...
<div class="max-w-6xl mx-auto px-6 lg:px-10 py-16">
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold font-serif text-brand-navy mb-4">Koleksi Puisi</h1>
        <p class="text-gray-500">Nikmati bait-bait puisi terbaik dari para penulis Riau.</p>
    </div>
    ...
    <div class="bg-[#F8FAFF] p-10 rounded-2xl text-center border border-gray-100">
        ...
        <p class="text-gray-500">Kami sedang menyiapkan karya-karya puisi terbaik untuk Anda baca di sini.</p>
