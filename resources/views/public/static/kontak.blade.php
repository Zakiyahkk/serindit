...
@section('title', 'Kontak - Serindit')

@section('content')
<div class="max-w-6xl mx-auto px-6 lg:px-10 py-16">
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold font-serif text-brand-navy mb-4">Hubungi Kami</h1>
        <p class="text-gray-500">Anda dapat menghubungi tim Balai Bahasa Provinsi Riau.</p>
    </div>
    ...
    <div class="bg-[#F8FAFF] p-10 rounded-2xl text-center border border-gray-100">
        ...
        <p class="text-gray-500">Informasi kontak akan segera dipublikasikan di halaman ini.</p>
