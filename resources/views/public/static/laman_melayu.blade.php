...
@section('title', 'Laman Melayu - Serindit')

@section('content')
<div class="max-w-6xl mx-auto px-6 lg:px-10 py-16">
    <div class="text-center mb-12">
        <h1 class="text-4xl font-bold font-serif text-brand-navy mb-4">Laman Melayu</h1>
        <p class="text-gray-500">Eksplorasi wawasan dan kebudayaan tanah Melayu Riau.</p>
    </div>
    ...
    <div class="bg-[#F8FAFF] p-10 rounded-2xl text-center border border-gray-100">
        ...
        <p class="text-gray-500">Kami sedang menyiapkan artikel Laman Melayu terbaik untuk Anda baca di sini.</p>
