...
@section('title', 'Tambah Laman Melayu — Admin')
...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="fw-bold mb-0" style="font-size:20px;">Tambah Laman Melayu</h2>
    <a href="{{ route('admin.laman-melayu.index') }}" class="btn btn-light" style="border-radius:10px;">
        <i class="bi bi-arrow-left me-1"></i> Kembali
    </a>
</div>

<form method="POST" action="{{ route('admin.laman-melayu.store') }}" enctype="multipart/form-data">
    @csrf
    <div class="row g-4">
        <div class="col-lg-8">
            <div class="form-card">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="penulis" class="form-control" value="{{ old('penulis', 'Penulis Riau') }}" required>
                </div>
        ...
        <div class="col-lg-4">
            <div class="form-card mb-4">
                ...
                <button type="submit" class="btn btn-success w-100 mt-3" style="border-radius:10px;">
                    <i class="bi bi-save me-1"></i> Simpan Tulisan
                </button>
            </div>
        </div>
    </div>
