...
@push('styles')
    <style>
        ...
        .books-card table tbody tr:last-child td {
            border-bottom: none;
        }

        .books-card table tbody tr:hover {
            background: #fafbff;
        }
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-btns justify-content-center">
                                        <a href="{{ route('admin.books.show', $book->id) }}" class="btn-action btn-view"
                                            title="Lihat Detail">
                                            <i class="bi bi-eye"></i>
                                        </a>
